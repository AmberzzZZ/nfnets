...
class GroupConv2DKT(Conv2D):
    ...
    def __init__(self, filters, kernel_size, groups=32, *args, **kwargs):
    ...
    def call(self, input):
        ...
        x = tf.nn.depthwise_conv2d(input, self.kernel, strides=self.strides,
...
class GroupConv2D(Conv2D):
    ...
    def __init__(self, filters, kernel_size, groups=4, *args, **kwargs):
    ...
    def build(self, input_shape):
        ...
        # declare [ndim, dtype and shape] of every input to a layer
